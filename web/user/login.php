<?php
 $mod='blank'; include("../api.inc.php"); $title='用户登录'; include './css.php'; ?>
			...
			<div>
				<div>
                   ...
                   <form action="./index.php" method="get" class="form-horizontal" role="form">
					...
					<p class="text-muted text-center"><a href="reg.php"><small>立即注册</small></a> | <a href="../daili/"><small>代理中心</small></a>
					</p>
                    </form>
			</div>
		</div>
	...
	<hr width="50%" />
	<p class="text-center">Copyright ©2016  <a class="" href="http://kangml.com">kangml.com</a> All Rights Reserved. 康师傅免流™  版权所有</p>
