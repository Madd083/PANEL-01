        ...
        <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-xs-12">
              ...
              <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                  <li class="active">
                    <a href="#">会员信息</a></li>
                  <li>
                    <a href="downloads.php" target="view_window">软件下载</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                  <li>
                    <a href="passwd.php" target="view_window">修改密码</a></li>
                  <li>
          ...
          <div class="row visible-lg-block vmargin-15">
            <div class="col-md-12 text-center">
              <ul class="pagination" style="margin: 0px; vertical-align: middle;">
                ...
                <li>
                <li class="active">
                  <a href="rankings.php" style="cursor: pointer;" target="view_window">更多...</a></li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 col-xs-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="progress">
                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="min-width: 2em; width: 100%;">∞</div></div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-xs-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <p class="text-center">
                    ...
                    <a href="#" class="btn btn-primary btn-xs">续费</a></p>
            ...
            <div class="col-md-4 col-xs-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-xs-12 text-center">
                      <a href="affiliate.php" class="btn btn-primary btn-xs btn-block" target="view_window">教我如何赚流量</a></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 col-xs-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-xs-12 text-center">
                      <a href="affiliate.php"  class="btn btn-primary btn-xs btn-block" target="view_window">教我如何购买流量</a></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 col-xs-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-xs-12 text-center">
                      <a href="affiliate.php" class="btn btn-primary btn-xs btn-block" target="view_window">教我如何下载软件</a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 text-center footer">
              <small>&copy; sulekeji.top 2016 使用本服务时，请自觉遵守中华人民共和国法律，并一切解释权归 sulekeji 所有</small></div>
          </div>
        </div>
      </div>
    </div>
