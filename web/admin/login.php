...
if(isset($_POST['user']) && isset($_POST['pass'])){
	...
	if($user==$adminuser && $pass==$adminpass) {
		...
		exit("<script language='javascript'>alert('登陆康师傅流控管理中心成功！');window.location.href='./';</script>");
	...
	exit("<script language='javascript'>alert('您已登陆过，正在进入康师傅流控管理中心');window.location.href='./';</script>");
}
$title='用户登录';
include './head.php';
?>
  <nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">康师傅流控管理中心</a>
      </div><!-- /.navbar-header -->
